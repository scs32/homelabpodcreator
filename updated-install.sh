...
FILES=(
    ...
    "create-orchestrator.sh"          # Replacement for create.sh
...
# Rename create-orchestrator.sh to create.sh for compatibility
mv create-orchestrator.sh create.sh
